        ...
        <div class="card shadow-sm">
            <div class="card-header" style="background-color: #f8f9fa; border-bottom: 1px solid #dee2e6;">
                <h1 class="h4 mb-0 text-dark">
                    <i class="bi bi-plus-circle me-2" style="color: #6c757d;"></i>Nova Tarefa
                </h1>
            </div>
            <div class="card-body">
                ...
                <g:form controller="task" action="save" class="needs-validation" novalidate="true">
                    <div class="mb-3">
                    ...
                    <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                        ...
                        <g:submitButton name="create" value="Criar Tarefa" class="btn" style="background-color: #28a745; border-color: #28a745; color: white;">
